...
api_id = 20447679
api_hash = "e8dc5a3b1e12263ee77c16a078326bc5"
phone_number = '+79518426430'  # телефонный номер аккаунта в телеграме
PUBLIC = 'Readovka'  # паблик
...
app = Client("data/my_account", api_id, api_hash,
